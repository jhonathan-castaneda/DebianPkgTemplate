...
if __name__=="__main__":
    ...
    parser.add_argument('--config',  type=str, default="config.ini", help = "(initial settings path) default: config.ini")
    ...
    try:
        ...
        pass
    """
#gdbus call --session --dest com.monitoreointeligente.retotecnico --object-path /com/monitoreointeligente/retotecnico --method com.monitoreointeligente.retotecnico.calcular "/home/john/Desktop/comsTest/by.mp3"  "md5"
